...
export default function AdsPage() {
  ...
  return (
    <div className="space-y-6" data-testid="ads-page">
      ...
      {/* Empty State */}
      <Card className="p-8 border border-border" data-testid="ads-empty-state">
      ...
      <div className="flex items-start gap-2 rounded-lg border border-border bg-muted/30 p-3 text-xs text-muted-foreground">
        ...
        <div>
          ...
          Meta Ads Manager API and TikTok Ads API. Connect your ad accounts in Settings to see live campaign data, spend tracking, and conversion metrics.
        </div>
      </div>
    </div>
  );
